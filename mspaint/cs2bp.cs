...
namespace mspaint
{
    public static class cs2bp
    {
        ...
        public static bool Run(string pathToDLL)
        {
            ...
            {
                throw new ApplicationException("Counter-Strike 2 not found.");
            }
        ...
        private static void InjectDLL(string path)
        {
            ...
            {
                throw new ApplicationException("Failed to open CS2 process.");
            }
        ...
        private static UInt32 GetGamePID()
        {
            ...
            Process[] proc = Process.GetProcessesByName("cs2");
        ...
        private static void BypassCS2Hook()
        {
        ...
        private static void RestoreCS2Hook()
        {
            for (int i = 0; i < _functions.Count; i++)
            {
